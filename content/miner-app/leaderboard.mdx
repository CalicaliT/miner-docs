...
By default, the Ethereum address is displayed as the username. You can change the username by going to the [Settings](https://docs.hummingbot.io/miner/miner-app/settings/) page.
